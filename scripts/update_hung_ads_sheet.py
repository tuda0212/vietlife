...
logger = logging.getLogger("update_hung_ads_sheet")
...
def main():
    ...
    target_gid = 233773706
    
    # 1. Truy vấn BigQuery lấy các ad của bác sĩ Hùng
    logger.info("Đang truy vấn BigQuery để lấy danh sách bài quảng cáo của BS Kiều Đình Hùng...")
