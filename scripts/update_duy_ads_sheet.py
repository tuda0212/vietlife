...
logger = logging.getLogger("update_duy_ads_sheet")
...
def main():
    ...
    # 1. Truy vấn BigQuery lấy các ad của bác sĩ Phạm Duy
    logger.info("Đang truy vấn BigQuery để lấy danh sách bài quảng cáo của BS Phạm Duy...")
    ...
    query = f"""
        ...
        WHERE (
          LOWER(doctor_name) LIKE '%phạm duy%' 
