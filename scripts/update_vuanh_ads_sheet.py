...
logger = logging.getLogger("update_vuanh_ads_sheet")
...
def main():
    ...
    target_gid = 981262330
    
    # 1. Truy vấn BigQuery lấy các ad của bác sĩ Vũ Anh
    logger.info("Đang truy vấn BigQuery để lấy danh sách bài quảng cáo của BS Vũ Anh...")
