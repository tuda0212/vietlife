...
logger = logging.getLogger("update_dinh_ads_sheet")
...
def main():
    ...
    target_gid = 1396031082
    
    # 1. Truy vấn BigQuery lấy các ad của bác sĩ Định
    logger.info("Đang truy vấn BigQuery để lấy danh sách bài quảng cáo của BS Định...")
