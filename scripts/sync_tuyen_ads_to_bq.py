...
logger = logging.getLogger("sync_tuyen_ads")

try:
    start_date = "2026-01-01"
    end_date = "2026-06-23"
    account_ids = ["act_1433365117712667"] # Cột Sống (BS Tuyên)
    
    logger.info(f"Bắt đầu chạy Facebook Ads Pipeline cho BS Tuyên từ {start_date} đến {end_date}...")
    res = pipeline.run(
