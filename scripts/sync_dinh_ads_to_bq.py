...
logger = logging.getLogger("sync_dinh_ads")

try:
    start_date = "2026-01-01"
    end_date = "2026-06-23"
    # Đồng bộ tài khoản act_736221869292755 (Cơ Xương Khớp)
    account_ids = ["act_736221869292755"]
    
    logger.info(f"Bắt đầu chạy Facebook Ads Pipeline cho tài khoản act_736221869292755 từ {start_date} đến {end_date}...")
    res = pipeline.run(
