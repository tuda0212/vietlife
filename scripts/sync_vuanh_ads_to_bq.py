...
logger = logging.getLogger("sync_vuanh_ads")

try:
    start_date = "2026-01-01"
    end_date = "2026-06-23"
    # Đồng bộ tài khoản act_1491394528173951
    account_ids = ["act_1491394528173951"]
    
    logger.info(f"Bắt đầu chạy Facebook Ads Pipeline cho tài khoản act_1491394528173951 từ {start_date} đến {end_date}...")
    res = pipeline.run(
