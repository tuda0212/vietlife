...
logger = logging.getLogger("sync_tuyen_main")

try:
    start_date = "2026-01-01"
    end_date = "2026-06-23"
    # Đồng bộ tài khoản act_696152742916012 (Thần Kinh, nơi chứa các chiến dịch của BS Tuyên)
    account_ids = ["act_696152742916012"]
    
    logger.info(f"Bắt đầu chạy Facebook Ads Pipeline cho tài khoản act_696152742916012 từ {start_date} đến {end_date}...")
    res = pipeline.run(
